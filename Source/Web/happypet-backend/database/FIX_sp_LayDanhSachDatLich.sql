...
PRINT N'✅ ĐÃ CẬP NHẬT sp_LayDanhSachDatLich'
PRINT N'   - Thêm field PhuongThucTT để phân biệt:'
PRINT N'     + NULL = Chưa xuất hóa đơn → Hiện nút "Xuất hóa đơn"'
PRINT N'     + Có giá trị = Đã xuất → Hiện "Đã xuất hóa đơn"'
GO
