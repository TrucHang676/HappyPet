    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '50px' }}>
            <div style={{ width: '400px', padding: '30px', border: '1px solid #ddd', borderRadius: '10px', boxShadow: '0 0 10px rgba(0,0,0,0.1)' }}>
                ...
                <h2 style={{ textAlign: 'center', color: '#E67E22' }}>Đăng Ký Thành Viên 🐶</h2>
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <p style={{ marginTop: '15px', textAlign: 'center' }}>
                        {/* Thay đổi màu link đăng nhập */}
                        Đã có tài khoản? <a href="/login" style={{ color: '#E67E22', fontWeight: 'bold' }}>Đăng nhập</a>
                    </p>
                </form>
            </div>
        </div>
