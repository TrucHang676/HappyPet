...
// import { ShoppingCart } from 'lucide-react'; // M nhớ cài lucide-react (npm install lucide-react)
// import './Shop.css';
...
//     const [cartCount, setCartCount] = useState(0); // Để hiện số lượng trên giỏ hàng

//     // Danh mục m muốn thay thế dropdown
//     const categories = [
//         { id: '', name: 'Tất cả', icon: '🐾' },
//         { id: 'T', name: 'Thuốc', icon: '💊' }, // Giả sử T là thuốc
//         { id: 'VC', name: 'Vaccine', icon: '💉' },
//         { id: 'SPK', name: 'Phụ kiện', icon: '🦴' }, // SPK là mặt hàng khác/phụ kiện
//     ];
...
//             const maKH = localStorage.getItem('maKH')?.trim() || 'U000001';
...
//                 setCartCount(prev => prev + 1); // Tăng số lượng giỏ hàng ảo
...
//             {/* Header Cửa hàng có Giỏ hàng */}
//             <header className="shop-header">
//                 <h2>🛒 Cửa Hàng HappyPet</h2>
//                 <div className="cart-icon-container">
//                     <ShoppingCart size={32} color="#e67e22" />
//                     {cartCount > 0 && <span className="cart-badge">{cartCount}</span>}
//                 </div>
//             </header>

//             {/* Banner Khuyến mãi (Giống hình m gửi) */}
//             <div className="shop-banner">
//                 <div className="banner-content">
//                     <h3>Yêu Thương Pet - Sale 20%</h3>
//                     <p>Toàn bộ phụ kiện thần 12</p>
//                     <button className="shop-now-btn">Shop now</button>
//                 </div>
//             </div>

//             {/* Thanh Danh mục thay cho Dropdown */}
//             <div className="category-nav">
//                 {categories.map(cat => (
//                     <button 
//                         key={cat.id} 
//                         className={`category-item ${type === cat.id ? 'active' : ''}`}
...
//             {/* Grid Sản phẩm */}
//             {loading ? <p className="loading">Đang tải hàng...</p> : (
//                 <div className="product-display-grid">
//                     {products.map(p => (
//                         <div key={p.MaMatHang} className="product-card-modern">
//                             {/* Chỗ để m chèn hình nè */}
//                             <div className="product-image-placeholder">
//                                 <img src={`https://via.placeholder.com/200?text=${p.TenMatHang}`} alt={p.TenMatHang} />
//                             </div>
//                             <div className="product-info">
//                                 <h4>{p.TenMatHang}</h4>
//                                 <p className="brand">{p.HangSX}</p>
//                                 <div className="price-tag">{p.DonGia}</div>
//                                 <button 
//                                     className="add-btn" 
//                                     disabled={p.TinhTrang === 'Hết hàng'}
//                                     onClick={() => handleAddToCart(p)}
//                                 >
//                                     {p.TinhTrang === 'Còn hàng' ? 'Thêm vào giỏ' : 'Hết hàng'}
//                                 </button>
//                             </div>
//                         </div>
//                     ))}
...
//                                 <img src={`https://via.placeholder.com/200?text=${p.TenMatHang.charAt(0)}`} alt={p.TenMatHang} />
